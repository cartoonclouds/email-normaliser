...
env.allowRemoteModels = process.env.NODE_ENV === "test" || process.env.ALLOW_REMOTE_MODELS === "true";
...
export { DEFAULT_AI_EMBEDDING_CANDIDATES, DEFAULT_BLOCKLIST, DEFAULT_FIX_DOMAINS, DEFAULT_FIX_TLDS, DEFAULT_FUZZY_DOMAIN_CANDIDATES, EmailChangeCodes, email_default as EmailDirective, EmailValidationCodes, __clearCache, aiSuggestEmailDomain, blocklisted, changeCodeToReason, checkDomain, checkTld, findClosestDomain, isEmpty, levenshtein2 as levenshtein, looksLikeEmail, normaliseEmail, normaliseEmailWithAI, useEmail, validateEmail, validationCodeToReason };
