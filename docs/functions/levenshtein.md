...
Defined in: [utils/email/fuzzyDomainMatching.ts:20](https://gitlab.com/good-life/glp-frontend/-/blob/main/packages/email-normaliser/src/utils/email/fuzzyDomainMatching.ts#L20)
